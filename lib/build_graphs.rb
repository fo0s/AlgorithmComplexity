...
def build_graph
  ...
  @datapoints.each do |datapoint|
    ...
    20.times do
      ...
      Timer.time { data_shuffled.bubble_sort }
      temp_data << Timer.elapsedTime
    end
  ...
  @datapoints.each do |datapoint|
    ...
    20.times do
      data_shuffled = data.shuffle
      Timer.time { data_shuffled.merge_sort }
      temp_data << Timer.elapsedTime
    end
  ...
  @datapoints.each do |datapoint|
    ...
    20.times do
      data_shuffled = data.shuffle
      Timer.time { data_shuffled.quick_sort }
      temp_data << Timer.elapsedTime
    end
  ...
  @datapoints.each do |datapoint|
    ...
    20.times do
      data_shuffled = data.shuffle
      Timer.time { data_shuffled.selection_sort }
      temp_data << Timer.elapsedTime
    end
  ...
  @datapoints.each do |datapoint|
    ...
    20.times do
      data_shuffled = data.shuffle
      Timer.time { data_shuffled.insertion_sort }
      temp_data << Timer.elapsedTime
    end
    @my_insertion_results << (temp_data.sort.shift(5).pop(5).sum / 200)
  end
  ...
  chart.add_dataset(label: 'my_insertion_sort (divided by 200)', data: @my_insertion_results)
